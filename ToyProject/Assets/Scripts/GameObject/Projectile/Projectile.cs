...
public class Projectile : MonoBehaviour
{
    ...
    protected Define.PROJECTILE_ACT_TYPE actType = Define.PROJECTILE_ACT_TYPE.PROJECTILE_ACT_TYPE_LINEAR;
    ...
    public void Shoot(Define.PROJECTILE_ACT_TYPE actType, GameObject shooter, GameObject target, Vector3 shootPos)
    {
        this.shooter = shooter;
        this.transform.position = shootPos; 
    ...
    public void Shoot(Define.PROJECTILE_ACT_TYPE actType, GameObject shooter, Vector3 direction, Vector3 shootPos)
    {
        this.shooter = shooter;
        this.transform.position = shootPos; 
